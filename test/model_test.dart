...
void main() {
  test('Midterm Alert Data parser', () {
    ...
    final MidtermAlertsData data = MidtermAlertsData.fromRawJson(rawData);
  ...
  test('Reward and Penalty Data parser', () {
    ...
    final RewardAndPenaltyData data = RewardAndPenaltyData.fromRawJson(rawData);
  ...
  test('Leave Data parser', () {
    ...
    final LeaveData data = LeaveData.fromRawJson(rawData);
