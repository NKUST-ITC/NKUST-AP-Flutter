...
LeaveData _$LeaveDataFromJson(Map<String, dynamic> json) => LeaveData(
      leaves: (json['data'] as List<dynamic>).map((e) => Leave.fromJson(e as Map<String, dynamic>)).toList(),
...
Leave _$LeaveFromJson(Map<String, dynamic> json) => Leave(
      ...
      leaveSections:
          (json['sections'] as List<dynamic>).map((e) => LeaveSections.fromJson(e as Map<String, dynamic>)).toList(),
    );
...
LeaveSections _$LeaveSectionsFromJson(Map<String, dynamic> json) => LeaveSections(
      section: json['section'] as String,
      reason: json['reason'] as String,
    );

Map<String, dynamic> _$LeaveSectionsToJson(LeaveSections instance) => <String, dynamic>{
