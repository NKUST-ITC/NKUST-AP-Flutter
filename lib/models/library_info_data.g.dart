...
LibraryInfoData _$LibraryInfoDataFromJson(Map<String, dynamic> json) => LibraryInfoData(
      data: LibraryInfo.fromJson(json['data'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$LibraryInfoDataToJson(LibraryInfoData instance) => <String, dynamic>{
...
Map<String, dynamic> _$LibraryInfoToJson(LibraryInfo instance) => <String, dynamic>{
