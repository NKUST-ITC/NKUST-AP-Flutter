...
class NkustLocalizationsJa extends NkustLocalizations with BaseTranslations<NkustLocale, NkustLocalizations> {
	...
	@override String get studentIdQueryChallengeFailed => 'ロボット認証を完了できませんでした。再試行するか、ブラウザで照会してください。';
	...
	@override String get zuvioNoCourses => 'コースがありません';
	@override String get zuvioRollcall => '点呼サインイン';
	@override String get zuvioRollcallEntryHint => 'GPS 位置サインイン';
	@override String get zuvioClickers => '問題リスト';
	@override String get zuvioAnswerHistory => '回答履歴';
	@override String get zuvioBulletin => 'お知らせ';
	@override String get zuvioForum => 'コース討論';
	@override String get zuvioComingSoon => '近日公開';
	@override String get zuvioTeacher => '教員';
	@override String get zuvioSemester => '学期';
	@override String get zuvioCourseId => 'コース ID';
	@override String get zuvioRollcallNotOpen => '現在進行中の点呼はありません';
	@override String get zuvioRollcallOpen => '点呼が進行中';
	@override String get zuvioRollcallGpsHint => '位置情報の許可をオンにしてサインインしてください';
	@override String get zuvioLocating => '位置情報を取得中…';
	@override String get zuvioLocationDenied => '位置情報を取得できません';
	@override String get zuvioLocationDeniedHint => '設定でこのアプリの位置情報の許可をオンにしてください';
	@override String get zuvioSigningIn => 'サインイン中…';
	@override String get zuvioSignInSuccess => 'サインイン完了';
	@override String get zuvioSignIn => 'サインイン';
	@override String get zuvioNoLiveClicker => '再生中の問題はありません';
	@override String get zuvioNoLiveClickerHint => '先生が問題を再生したら、引っ張って更新すると回答できます';
	@override String get zuvioClickerLive => '問題を再生中';
	@override String get zuvioClickerAnswer => '回答';
	@override String get zuvioClickerAnswered => '回答済み';
	@override String get zuvioHistoryAnswers => '回答記録';
	@override String get zuvioHistoryAttendance => '点呼記録';
	@override String get zuvioOpenAt => '公開時間';
	@override String get zuvioStatusOnTime => '定刻';
	@override String get zuvioStatusLate => '遅延';
	@override String get zuvioStatusMissed => '未回答';
	@override String get zuvioBulletinNotice => 'お知らせ';
	@override String get zuvioBulletinCourse => 'コース情報';
	@override String get zuvioFeedback => 'フィードバック';
	@override String get zuvioFeedbackDm => '先生にメッセージ';
	@override String get zuvioFeedbackForum => '公開討論';
	@override String get zuvioFeedbackEmpty => 'メッセージはまだありません';
	@override String get zuvioFeedbackHint => 'メッセージを入力…';
	@override String get zuvioStickerUnderstand => 'わかった';
	@override String get zuvioStickerInteresting => '面白い';
	@override String get zuvioStickerTooFast => '速すぎ';
...
extension on NkustLocalizationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'studentIdQueryChallengeFailed' => 'ロボット認証を完了できませんでした。再試行するか、ブラウザで照会してください。',
			...
			'zuvioNoCourses' => 'コースがありません',
			'zuvioRollcall' => '点呼サインイン',
			'zuvioRollcallEntryHint' => 'GPS 位置サインイン',
			'zuvioClickers' => '問題リスト',
			'zuvioAnswerHistory' => '回答履歴',
			'zuvioBulletin' => 'お知らせ',
			'zuvioForum' => 'コース討論',
			'zuvioComingSoon' => '近日公開',
			'zuvioTeacher' => '教員',
			'zuvioSemester' => '学期',
			'zuvioCourseId' => 'コース ID',
			'zuvioRollcallNotOpen' => '現在進行中の点呼はありません',
			'zuvioRollcallOpen' => '点呼が進行中',
			'zuvioRollcallGpsHint' => '位置情報の許可をオンにしてサインインしてください',
			'zuvioLocating' => '位置情報を取得中…',
			'zuvioLocationDenied' => '位置情報を取得できません',
			'zuvioLocationDeniedHint' => '設定でこのアプリの位置情報の許可をオンにしてください',
			'zuvioSigningIn' => 'サインイン中…',
			'zuvioSignInSuccess' => 'サインイン完了',
			'zuvioSignIn' => 'サインイン',
			'zuvioNoLiveClicker' => '再生中の問題はありません',
			'zuvioNoLiveClickerHint' => '先生が問題を再生したら、引っ張って更新すると回答できます',
			'zuvioClickerLive' => '問題を再生中',
			'zuvioClickerAnswer' => '回答',
			'zuvioClickerAnswered' => '回答済み',
			'zuvioHistoryAnswers' => '回答記録',
			'zuvioHistoryAttendance' => '点呼記録',
			'zuvioOpenAt' => '公開時間',
			'zuvioStatusOnTime' => '定刻',
			'zuvioStatusLate' => '遅延',
			'zuvioStatusMissed' => '未回答',
			'zuvioBulletinNotice' => 'お知らせ',
			'zuvioBulletinCourse' => 'コース情報',
			'zuvioFeedback' => 'フィードバック',
			'zuvioFeedbackDm' => '先生にメッセージ',
			'zuvioFeedbackForum' => '公開討論',
			'zuvioFeedbackEmpty' => 'メッセージはまだありません',
			'zuvioFeedbackHint' => 'メッセージを入力…',
			'zuvioStickerUnderstand' => 'わかった',
			'zuvioStickerInteresting' => '面白い',
			'zuvioStickerTooFast' => '速すぎ',
