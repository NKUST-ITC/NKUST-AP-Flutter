class ApStatusCode {
  ...
  /// Session expired — used by [ApSessionExpiredException] /
  /// [BusSessionExpiredException]. Matches HTTP 401 numerically for
  /// backwards compatibility with earlier status-code dumps, but is
  /// conceptually independent of any HTTP-layer meaning now that the
  /// app is crawler-only.
